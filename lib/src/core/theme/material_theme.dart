...
/// Esquemas de color generados con Material Theme Builder.
///
/// Paleta basada en el color primario de SisMMun (azul-morado institucional).
/// Incluye variantes de contraste para accesibilidad.
class MaterialTheme {
